...
goog.exportSymbol('proto.proto.ChatMsgDeletedEvent', null, global);
 ...
 * @constructor
 */
proto.proto.ChatMsgDeletedEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.ChatMsgDeletedEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.ChatMsgDeletedEvent.displayName = 'proto.proto.ChatMsgDeletedEvent';
}
 ...
 * @const
 */
proto.proto.ChatMsgEvent.repeatedFields_ = [4,5,6];
 ...
 */
proto.proto.ChatMsgEvent.prototype.getSender = function() {
  return /** @type{?proto.proto.User} */ (
    jspb.Message.getWrapperField(this, grpc_user_pb.User, 2));
};
 ...
 * @return {!proto.proto.ChatMsgEvent} returns this
*/
proto.proto.ChatMsgEvent.prototype.setSender = function(value) {
 ...
 * @return {!proto.proto.ChatMsgEvent} returns this
 */
proto.proto.ChatMsgEvent.prototype.clearSender = function() {
 ...
 * @return {boolean}
 */
proto.proto.ChatMsgEvent.prototype.hasSender = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional User reciever = 3;
 * @return {?proto.proto.User}
 */
proto.proto.ChatMsgEvent.prototype.getReciever = function() {
  return /** @type{?proto.proto.User} */ (
 ...
 * @return {!proto.proto.ChatMsgEvent} returns this
*/
proto.proto.ChatMsgEvent.prototype.setReciever = function(value) {
 ...
 * @return {!proto.proto.ChatMsgEvent} returns this
 */
proto.proto.ChatMsgEvent.prototype.clearReciever = function() {
 ...
 * @return {boolean}
 */
proto.proto.ChatMsgEvent.prototype.hasReciever = function() {
 ...
 * @return {!Array<string>}
 */
proto.proto.ChatMsgEvent.prototype.getAttachmentsList = function() {
 ...
 * @return {!proto.proto.ChatMsgEvent} returns this
 */
proto.proto.ChatMsgEvent.prototype.setAttachmentsList = function(value) {
 ...
 * @return {!proto.proto.ChatMsgEvent} returns this
 */
proto.proto.ChatMsgEvent.prototype.addAttachments = function(value, opt_index) {
 ...
 * @return {!proto.proto.ChatMsgEvent} returns this
 */
proto.proto.ChatMsgEvent.prototype.clearAttachmentsList = function() {
 ...
 * @return {!Object}
 */
proto.proto.ChatMsgDeletedEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.ChatMsgDeletedEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.ChatMsgDeletedEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.ChatMsgDeletedEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.ChatMsgDeletedEvent}
 */
proto.proto.ChatMsgDeletedEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.ChatMsgDeletedEvent;
  return proto.proto.ChatMsgDeletedEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.ChatMsgDeletedEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.ChatMsgDeletedEvent}
 */
proto.proto.ChatMsgDeletedEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.ChatMsgDeletedEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.ChatMsgDeletedEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.ChatMsgDeletedEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.ChatMsgDeletedEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.proto.ChatMsgDeletedEvent.prototype.getMessageId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.proto.ChatMsgDeletedEvent} returns this
 */
proto.proto.ChatMsgDeletedEvent.prototype.setMessageId = function(value) {
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.proto.ChatMsgDeletedEvent.prototype.getDeletedAt = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
 ...
 * @return {!proto.proto.ChatMsgDeletedEvent} returns this
*/
proto.proto.ChatMsgDeletedEvent.prototype.setDeletedAt = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.proto.ChatMsgDeletedEvent} returns this
 */
proto.proto.ChatMsgDeletedEvent.prototype.clearDeletedAt = function() {
 ...
 * @return {boolean}
 */
proto.proto.ChatMsgDeletedEvent.prototype.hasDeletedAt = function() {
  return jspb.Message.getField(this, 2) != null;
};
