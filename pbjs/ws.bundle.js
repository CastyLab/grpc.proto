...
$root.proto = (function() {
    ...
    proto.CMsgProtoBufHeader = (function() {
        ...
        CMsgProtoBufHeader.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.UserHash != null && Object.hasOwnProperty.call(message, "UserHash"))
            ...
            if (message.SessionClientId != null && Object.hasOwnProperty.call(message, "SessionClientId"))
    ...
    proto.ChatMsgEvent = (function() {
        ...
        ChatMsgEvent.encode = function encode(message, writer) {
            ...
            if (message.reciever != null && Object.hasOwnProperty.call(message, "reciever"))
    ...
    proto.User = (function() {
        ...
        User.encode = function encode(message, writer) {
            ...
            if (message.twoFaEnabled != null && Object.hasOwnProperty.call(message, "twoFaEnabled"))
    ...
    proto.UpdatePasswordRequest = (function() {
        ...
        UpdatePasswordRequest.encode = function encode(message, writer) {
            ...
            if (message.verifyNewPassword != null && Object.hasOwnProperty.call(message, "verifyNewPassword"))
    ...
    proto.ConnectionRequest = (function() {

        /**
         * Properties of a ConnectionRequest.
         * @memberof proto
         * @interface IConnectionRequest
         * @property {proto.IConnection|null} [connection] ConnectionRequest connection
         * @property {proto.IAuthenticateRequest|null} [authRequest] ConnectionRequest authRequest
         */
         ...
         * @constructor
         * @param {proto.IConnectionRequest=} [properties] Properties to set
         */
         ...
         * @memberof proto.ConnectionRequest
         * @instance
         */
        ConnectionRequest.prototype.connection = null;

        /**
         * ConnectionRequest authRequest.
         * @member {proto.IAuthenticateRequest|null|undefined} authRequest
         * @memberof proto.ConnectionRequest
         * @instance
         */
        ConnectionRequest.prototype.authRequest = null;
         ...
         * @static
         * @param {proto.IConnectionRequest=} [properties] Properties to set
         * @returns {proto.ConnectionRequest} ConnectionRequest instance
         */
        ...
        /**
         * Encodes the specified ConnectionRequest message. Does not implicitly {@link proto.ConnectionRequest.verify|verify} messages.
         * @function encode
         * @memberof proto.ConnectionRequest
         * @static
         * @param {proto.IConnectionRequest} message ConnectionRequest message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified ConnectionRequest message, length delimited. Does not implicitly {@link proto.ConnectionRequest.verify|verify} messages.
         * @function encodeDelimited
         * @memberof proto.ConnectionRequest
         * @static
         * @param {proto.IConnectionRequest} message ConnectionRequest message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {proto.ConnectionRequest} ConnectionRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ConnectionRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.ConnectionRequest();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        ConnectionRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.ConnectionRequest)
                return object;
            var message = new $root.proto.ConnectionRequest();
            if (object.connection != null) {
                if (typeof object.connection !== "object")
                    throw TypeError(".proto.ConnectionRequest.connection: object expected");
                message.connection = $root.proto.Connection.fromObject(object.connection);
            }
            if (object.authRequest != null) {
                if (typeof object.authRequest !== "object")
                    throw TypeError(".proto.ConnectionRequest.authRequest: object expected");
                message.authRequest = $root.proto.AuthenticateRequest.fromObject(object.authRequest);
            }
            return message;
        };
         ...
         * @memberof proto.ConnectionRequest
         * @static
         * @param {proto.ConnectionRequest} message ConnectionRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    proto.UserService = (function() {
         ...
         * @memberof proto.UserService
         * @instance
         * @param {proto.IConnectionRequest} request ConnectionRequest message or plain object
        ...
        Object.defineProperty(UserService.prototype.getConnection = function getConnection(request, callback) {
            return this.rpcCall(getConnection, $root.proto.ConnectionRequest, $root.proto.ConnectionsResponse, request, callback);
        ...
        /**
         * Callback as used by {@link proto.UserService#getConnections}.
         * @memberof proto.UserService
         ...
         * @instance
         * @param {proto.IAuthenticateRequest} request AuthenticateRequest message or plain object
         * @param {proto.UserService.GetConnectionsCallback} callback Node-style callback called with the error, if any, and ConnectionsResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(UserService.prototype.getConnections = function getConnections(request, callback) {
            return this.rpcCall(getConnections, $root.proto.AuthenticateRequest, $root.proto.ConnectionsResponse, request, callback);
        ...
        /**
         * Callback as used by {@link proto.UserService#updateConnection}.
         * @memberof proto.UserService
         ...
         * @instance
         * @param {proto.IConnectionRequest} request ConnectionRequest message or plain object
         * @param {proto.UserService.UpdateConnectionCallback} callback Node-style callback called with the error, if any, and ConnectionsResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(UserService.prototype.updateConnection = function updateConnection(request, callback) {
            return this.rpcCall(updateConnection, $root.proto.ConnectionRequest, $root.proto.ConnectionsResponse, request, callback);
    ...
    proto.AuthResponse = (function() {
        ...
        AuthResponse.encode = function encode(message, writer) {
            ...
            if (message.refreshedToken != null && Object.hasOwnProperty.call(message, "refreshedToken"))
    ...
    proto.OAUTHRequest = (function() {
         ...
         * @member {proto.Connection.Type} service
    ...
    proto.Connection = (function() {
         ...
         * @property {string|null} [refreshedToken] Connection refreshedToken
         * @property {boolean|null} [showActivity] Connection showActivity
         * @property {string|null} [userId] Connection userId
         * @property {google.protobuf.ITimestamp|null} [createdAt] Connection createdAt
         * @property {google.protobuf.ITimestamp|null} [updatedAt] Connection updatedAt
         */
         ...
         * @constructor
         * @param {proto.IConnection=} [properties] Properties to set
         */
        ...
        /**
         * Connection type.
         * @member {proto.Connection.Type} type
         * @memberof proto.Connection
         * @instance
         */
        ...
        /**
         * Connection refreshedToken.
         * @member {string} refreshedToken
         * @memberof proto.Connection
         * @instance
         */
        Connection.prototype.refreshedToken = "";

        /**
         * Connection showActivity.
         * @member {boolean} showActivity
         * @memberof proto.Connection
         * @instance
         */
        Connection.prototype.showActivity = false;
         ...
         * @instance
         */
        Connection.prototype.createdAt = null;
         ...
         * @instance
         */
        Connection.prototype.updatedAt = null;
         ...
         * @static
         * @param {proto.IConnection=} [properties] Properties to set
         * @returns {proto.Connection} Connection instance
         */
        ...
        /**
         * Encodes the specified Connection message. Does not implicitly {@link proto.Connection.verify|verify} messages.
         * @function encode
         * @memberof proto.Connection
         * @static
         * @param {proto.IConnection} message Connection message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Connection.encode = function encode(message, writer) {
            ...
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.id);
            if (message.serviceUserId != null && Object.hasOwnProperty.call(message, "serviceUserId"))
            ...
            if (message.showActivity != null && Object.hasOwnProperty.call(message, "showActivity"))
        ...
        /**
         * Encodes the specified Connection message, length delimited. Does not implicitly {@link proto.Connection.verify|verify} messages.
         * @function encodeDelimited
         * @memberof proto.Connection
         * @static
         * @param {proto.IConnection} message Connection message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {proto.Connection} Connection
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Connection.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.Connection();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Connection.verify = function verify(message) {
            ...
            if (message.refreshedToken != null && message.hasOwnProperty("refreshedToken"))
                if (!$util.isString(message.refreshedToken))
                    return "refreshedToken: string expected";
            if (message.showActivity != null && message.hasOwnProperty("showActivity"))
                if (typeof message.showActivity !== "boolean")
                    return "showActivity: boolean expected";
            if (message.userId != null && message.hasOwnProperty("userId"))
                if (!$util.isString(message.userId))
                    return "userId: string expected";
            if (message.createdAt != null && message.hasOwnProperty("createdAt")) {
        ...
        Connection.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.Connection)
                return object;
            ...
            if (object.refreshedToken != null)
                message.refreshedToken = String(object.refreshedToken);
            if (object.showActivity != null)
                message.showActivity = Boolean(object.showActivity);
            if (object.userId != null)
                message.userId = String(object.userId);
            if (object.createdAt != null) {
                if (typeof object.createdAt !== "object")
                    throw TypeError(".proto.Connection.createdAt: object expected");
                message.createdAt = $root.google.protobuf.Timestamp.fromObject(object.createdAt);
            }
            if (object.updatedAt != null) {
                if (typeof object.updatedAt !== "object")
                    throw TypeError(".proto.Connection.updatedAt: object expected");
                message.updatedAt = $root.google.protobuf.Timestamp.fromObject(object.updatedAt);
            }
            return message;
        };
         ...
         * @memberof proto.Connection
         * @static
         * @param {proto.Connection} message Connection
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Connection.toObject = function toObject(message, options) {
            ...
            if (message.type != null && message.hasOwnProperty("type"))
                object.type = options.enums === String ? $root.proto.Connection.Type[message.type] : message.type;
            if (message.accessToken != null && message.hasOwnProperty("accessToken"))
                object.accessToken = message.accessToken;
            if (message.refreshedToken != null && message.hasOwnProperty("refreshedToken"))
                object.refreshedToken = message.refreshedToken;
            if (message.showActivity != null && message.hasOwnProperty("showActivity"))
                object.showActivity = message.showActivity;
            if (message.userId != null && message.hasOwnProperty("userId"))
                object.userId = message.userId;
            if (message.createdAt != null && message.hasOwnProperty("createdAt"))
                object.createdAt = $root.google.protobuf.Timestamp.toObject(message.createdAt, options);
        ...
        /**
         * Type enum.
         * @name proto.Connection.Type
         * @enum {number}
         * @property {number} UNKNOWN=0 UNKNOWN value
         * @property {number} GOOGLE=1 GOOGLE value
         * @property {number} YOUTUBE=2 YOUTUBE value
         * @property {number} GITHUB=3 GITHUB value
         * @property {number} DISCORD=4 DISCORD value
         * @property {number} SPOTIFY=5 SPOTIFY value
         * @property {number} SOUND_CLOUD=6 SOUND_CLOUD value
         */
        Connection.Type = (function() {
            ...
            values[valuesById[5] = "SPOTIFY"] = 5;
            values[valuesById[6] = "SOUND_CLOUD"] = 6;
            return values;
        })();
    ...
    proto.ConnectionsResponse = (function() {

        /**
         * Properties of a ConnectionsResponse.
         * @memberof proto
         * @interface IConnectionsResponse
         * @property {number|Long|null} [code] ConnectionsResponse code
         * @property {string|null} [status] ConnectionsResponse status
         * @property {string|null} [message] ConnectionsResponse message
         * @property {Array.<proto.IConnection>|null} [result] ConnectionsResponse result
         */

        /**
         * Constructs a new ConnectionsResponse.
         * @memberof proto
         * @classdesc Represents a ConnectionsResponse.
         * @implements IConnectionsResponse
         * @constructor
         * @param {proto.IConnectionsResponse=} [properties] Properties to set
         */
        function ConnectionsResponse(properties) {
            this.result = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * ConnectionsResponse code.
         * @member {number|Long} code
         * @memberof proto.ConnectionsResponse
         * @instance
         */
        ConnectionsResponse.prototype.code = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @instance
         */
        ConnectionsResponse.prototype.status = "";
         ...
         * @instance
         */
        ConnectionsResponse.prototype.message = "";

        /**
         * ConnectionsResponse result.
         * @member {Array.<proto.IConnection>} result
         * @memberof proto.ConnectionsResponse
         * @instance
         */
        ConnectionsResponse.prototype.result = $util.emptyArray;

        /**
         * Creates a new ConnectionsResponse instance using the specified properties.
         * @function create
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {proto.IConnectionsResponse=} [properties] Properties to set
         * @returns {proto.ConnectionsResponse} ConnectionsResponse instance
         */
        ConnectionsResponse.create = function create(properties) {
            return new ConnectionsResponse(properties);
        };

        /**
         * Encodes the specified ConnectionsResponse message. Does not implicitly {@link proto.ConnectionsResponse.verify|verify} messages.
         * @function encode
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {proto.IConnectionsResponse} message ConnectionsResponse message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ConnectionsResponse.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.code != null && Object.hasOwnProperty.call(message, "code"))
                writer.uint32(/* id 1, wireType 0 =*/8).int64(message.code);
            ...
            if (message.result != null && message.result.length)
                for (var i = 0; i < message.result.length; ++i)
                    $root.proto.Connection.encode(message.result[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified ConnectionsResponse message, length delimited. Does not implicitly {@link proto.ConnectionsResponse.verify|verify} messages.
         * @function encodeDelimited
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {proto.IConnectionsResponse} message ConnectionsResponse message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ConnectionsResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a ConnectionsResponse message from the specified reader or buffer.
         * @function decode
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {proto.ConnectionsResponse} ConnectionsResponse
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ConnectionsResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.ConnectionsResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 4:
                    if (!(message.result && message.result.length))
                        message.result = [];
                    message.result.push($root.proto.Connection.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a ConnectionsResponse message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ConnectionsResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ConnectionsResponse message.
         * @function verify
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ConnectionsResponse.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.code != null && message.hasOwnProperty("code"))
                if (!$util.isInteger(message.code) && !(message.code && $util.isInteger(message.code.low) && $util.isInteger(message.code.high)))
            ...
            if (message.result != null && message.hasOwnProperty("result")) {
                if (!Array.isArray(message.result))
                    return "result: array expected";
                for (var i = 0; i < message.result.length; ++i) {
                    var error = $root.proto.Connection.verify(message.result[i]);
                    if (error)
                        return "result." + error;
                }
            }
        ...
        /**
         * Creates a ConnectionsResponse message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {proto.ConnectionsResponse} ConnectionsResponse
         */
        ConnectionsResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.ConnectionsResponse)
                return object;
            var message = new $root.proto.ConnectionsResponse();
            if (object.code != null)
                if ($util.Long)
                    (message.code = $util.Long.fromValue(object.code)).unsigned = false;
                else if (typeof object.code === "string")
            ...
            if (object.result) {
                if (!Array.isArray(object.result))
                    throw TypeError(".proto.ConnectionsResponse.result: array expected");
                message.result = [];
                for (var i = 0; i < object.result.length; ++i) {
                    if (typeof object.result[i] !== "object")
                        throw TypeError(".proto.ConnectionsResponse.result: object expected");
                    message.result[i] = $root.proto.Connection.fromObject(object.result[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a ConnectionsResponse message. Also converts values to other types if specified.
         * @function toObject
         * @memberof proto.ConnectionsResponse
         * @static
         * @param {proto.ConnectionsResponse} message ConnectionsResponse
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ConnectionsResponse.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
            ...
            if (message.result && message.result.length) {
                object.result = [];
                for (var j = 0; j < message.result.length; ++j)
                    object.result[j] = $root.proto.Connection.toObject(message.result[j], options);
            }
            return object;
        };

        /**
         * Converts this ConnectionsResponse to JSON.
         * @function toJSON
         * @memberof proto.ConnectionsResponse
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ConnectionsResponse.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    proto.Device = (function() {
        ...
        Device.encode = function encode(message, writer) {
            ...
            if (message.manifacture != null && Object.hasOwnProperty.call(message, "manifacture"))
    ...
    proto.TheaterVideoPlayer = (function() {
        ...
        TheaterVideoPlayer.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.theaterId != null && Object.hasOwnProperty.call(message, "theaterId"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.theaterId);
            if (message.mediaSource != null && Object.hasOwnProperty.call(message, "mediaSource"))
    ...
    proto.MediaSourceChangedEvent = (function() {
        ...
        MediaSourceChangedEvent.encode = function encode(message, writer) {
            ...
            if (message.theaterId != null && Object.hasOwnProperty.call(message, "theaterId"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.theaterId);
            if (message.mediaSourceId != null && Object.hasOwnProperty.call(message, "mediaSourceId"))
    ...
    proto.Theater = (function() {
        ...
        Theater.encode = function encode(message, writer) {
            ...
            if (message.videoPlayerAccess != null && Object.hasOwnProperty.call(message, "videoPlayerAccess"))
    ...
    proto.TheaterAuthRequest = (function() {
        ...
        TheaterAuthRequest.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.theater != null && Object.hasOwnProperty.call(message, "theater"))
    ...
    proto.RemoveSubtitleRequest = (function() {
        ...
        RemoveSubtitleRequest.encode = function encode(message, writer) {
            ...
            if (message.authRequest != null && Object.hasOwnProperty.call(message, "authRequest"))
                $root.proto.AuthenticateRequest.encode(message.authRequest, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.subtitleId != null && Object.hasOwnProperty.call(message, "subtitleId"))
    ...
    proto.Follow = (function() {
        ...
        Follow.encode = function encode(message, writer) {
            ...
            if (message.emailNotification != null && Object.hasOwnProperty.call(message, "emailNotification"))
                writer.uint32(/* id 6, wireType 0 =*/48).bool(message.emailNotification);
            if (message.pushNotification != null && Object.hasOwnProperty.call(message, "pushNotification"))
    ...
    proto.AddSubtitlesRequest = (function() {

        /**
         * Properties of an AddSubtitlesRequest.
         * @memberof proto
        ...
        /**
         * Constructs a new AddSubtitlesRequest.
         * @memberof proto
         * @classdesc Represents an AddSubtitlesRequest.
         * @implements IAddSubtitlesRequest
         * @constructor
        ...
        /**
         * AddSubtitlesRequest authRequest.
         * @member {proto.IAuthenticateRequest|null|undefined} authRequest
         * @memberof proto.AddSubtitlesRequest
         * @instance
         */
        AddSubtitlesRequest.prototype.authRequest = null;

        /**
         * AddSubtitlesRequest mediaSourceId.
         * @member {string} mediaSourceId
         * @memberof proto.AddSubtitlesRequest
         * @instance
         */
         ...
         * @static
         * @param {proto.IAddSubtitlesRequest=} [properties] Properties to set
         * @returns {proto.AddSubtitlesRequest} AddSubtitlesRequest instance
         */
        AddSubtitlesRequest.create = function create(properties) {
            return new AddSubtitlesRequest(properties);
        };

        /**
         * Encodes the specified AddSubtitlesRequest message. Does not implicitly {@link proto.AddSubtitlesRequest.verify|verify} messages.
         * @function encode
         * @memberof proto.AddSubtitlesRequest
         * @static
         * @param {proto.IAddSubtitlesRequest} message AddSubtitlesRequest message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        AddSubtitlesRequest.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.authRequest != null && Object.hasOwnProperty.call(message, "authRequest"))
                $root.proto.AuthenticateRequest.encode(message.authRequest, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        ...
        /**
         * Encodes the specified AddSubtitlesRequest message, length delimited. Does not implicitly {@link proto.AddSubtitlesRequest.verify|verify} messages.
         * @function encodeDelimited
         * @memberof proto.AddSubtitlesRequest
         * @static
         * @param {proto.IAddSubtitlesRequest} message AddSubtitlesRequest message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AddSubtitlesRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes an AddSubtitlesRequest message from the specified reader or buffer.
         * @function decode
         * @memberof proto.AddSubtitlesRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {proto.AddSubtitlesRequest} AddSubtitlesRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        AddSubtitlesRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.AddSubtitlesRequest();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes an AddSubtitlesRequest message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof proto.AddSubtitlesRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        AddSubtitlesRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies an AddSubtitlesRequest message.
         * @function verify
         * @memberof proto.AddSubtitlesRequest
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        AddSubtitlesRequest.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.authRequest != null && message.hasOwnProperty("authRequest")) {
                var error = $root.proto.AuthenticateRequest.verify(message.authRequest);
        ...
        /**
         * Creates an AddSubtitlesRequest message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof proto.AddSubtitlesRequest
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {proto.AddSubtitlesRequest} AddSubtitlesRequest
         */
        AddSubtitlesRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.AddSubtitlesRequest)
                return object;
            var message = new $root.proto.AddSubtitlesRequest();
            if (object.authRequest != null) {
                if (typeof object.authRequest !== "object")
                    throw TypeError(".proto.AddSubtitlesRequest.authRequest: object expected");
                message.authRequest = $root.proto.AuthenticateRequest.fromObject(object.authRequest);
            }
            if (object.mediaSourceId != null)
                message.mediaSourceId = String(object.mediaSourceId);
        ...
        /**
         * Creates a plain object from an AddSubtitlesRequest message. Also converts values to other types if specified.
         * @function toObject
         * @memberof proto.AddSubtitlesRequest
         * @static
         * @param {proto.AddSubtitlesRequest} message AddSubtitlesRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        AddSubtitlesRequest.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
        ...
        /**
         * Converts this AddSubtitlesRequest to JSON.
         * @function toJSON
         * @memberof proto.AddSubtitlesRequest
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        AddSubtitlesRequest.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return AddSubtitlesRequest;
    })();

    proto.SubtitlesResponse = (function() {

        /**
         * Properties of a SubtitlesResponse.
         * @memberof proto
         * @interface ISubtitlesResponse
         * @property {number|Long|null} [code] SubtitlesResponse code
         * @property {string|null} [status] SubtitlesResponse status
         * @property {string|null} [message] SubtitlesResponse message
         * @property {Array.<proto.ISubtitle>|null} [result] SubtitlesResponse result
         */

        /**
         * Constructs a new SubtitlesResponse.
         * @memberof proto
         * @classdesc Represents a SubtitlesResponse.
         * @implements ISubtitlesResponse
         * @constructor
         * @param {proto.ISubtitlesResponse=} [properties] Properties to set
         */
        function SubtitlesResponse(properties) {
            this.result = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * SubtitlesResponse code.
         * @member {number|Long} code
         * @memberof proto.SubtitlesResponse
         * @instance
         */
        SubtitlesResponse.prototype.code = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @instance
         */
        SubtitlesResponse.prototype.status = "";

        /**
         * SubtitlesResponse message.
         * @member {string} message
         * @memberof proto.SubtitlesResponse
         * @instance
         */
        SubtitlesResponse.prototype.message = "";

        /**
         * SubtitlesResponse result.
         * @member {Array.<proto.ISubtitle>} result
         * @memberof proto.SubtitlesResponse
         * @instance
         */
        SubtitlesResponse.prototype.result = $util.emptyArray;

        /**
         * Creates a new SubtitlesResponse instance using the specified properties.
         * @function create
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {proto.ISubtitlesResponse=} [properties] Properties to set
         * @returns {proto.SubtitlesResponse} SubtitlesResponse instance
         */
        SubtitlesResponse.create = function create(properties) {
            return new SubtitlesResponse(properties);
        };

        /**
         * Encodes the specified SubtitlesResponse message. Does not implicitly {@link proto.SubtitlesResponse.verify|verify} messages.
         * @function encode
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {proto.ISubtitlesResponse} message SubtitlesResponse message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SubtitlesResponse.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.code != null && Object.hasOwnProperty.call(message, "code"))
                writer.uint32(/* id 1, wireType 0 =*/8).int64(message.code);
        ...
        /**
         * Encodes the specified SubtitlesResponse message, length delimited. Does not implicitly {@link proto.SubtitlesResponse.verify|verify} messages.
         * @function encodeDelimited
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {proto.ISubtitlesResponse} message SubtitlesResponse message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SubtitlesResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a SubtitlesResponse message from the specified reader or buffer.
         * @function decode
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {proto.SubtitlesResponse} SubtitlesResponse
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SubtitlesResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.SubtitlesResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a SubtitlesResponse message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SubtitlesResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SubtitlesResponse message.
         * @function verify
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SubtitlesResponse.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.code != null && message.hasOwnProperty("code"))
                if (!$util.isInteger(message.code) && !(message.code && $util.isInteger(message.code.low) && $util.isInteger(message.code.high)))
        ...
        /**
         * Creates a SubtitlesResponse message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {proto.SubtitlesResponse} SubtitlesResponse
         */
        SubtitlesResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.SubtitlesResponse)
                return object;
            var message = new $root.proto.SubtitlesResponse();
            if (object.code != null)
                if ($util.Long)
                    (message.code = $util.Long.fromValue(object.code)).unsigned = false;
                else if (typeof object.code === "string")
            ...
            if (object.result) {
                if (!Array.isArray(object.result))
                    throw TypeError(".proto.SubtitlesResponse.result: array expected");
                message.result = [];
                for (var i = 0; i < object.result.length; ++i) {
                    if (typeof object.result[i] !== "object")
                        throw TypeError(".proto.SubtitlesResponse.result: object expected");
                    message.result[i] = $root.proto.Subtitle.fromObject(object.result[i]);
                }
            }
            return message;
        ...
        /**
         * Creates a plain object from a SubtitlesResponse message. Also converts values to other types if specified.
         * @function toObject
         * @memberof proto.SubtitlesResponse
         * @static
         * @param {proto.SubtitlesResponse} message SubtitlesResponse
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SubtitlesResponse.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
        ...
        /**
         * Converts this SubtitlesResponse to JSON.
         * @function toJSON
         * @memberof proto.SubtitlesResponse
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SubtitlesResponse.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    proto.TheaterService = (function() {
        ...
        /**
         * Callback as used by {@link proto.TheaterService#addSubtitles}.
         * @memberof proto.TheaterService
         * @typedef AddSubtitlesCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {proto.SubtitlesResponse} [response] SubtitlesResponse
         */
         ...
         * @memberof proto.TheaterService
         * @instance
         * @param {proto.IAddSubtitlesRequest} request AddSubtitlesRequest message or plain object
         * @param {proto.TheaterService.AddSubtitlesCallback} callback Node-style callback called with the error, if any, and SubtitlesResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(TheaterService.prototype.addSubtitles = function addSubtitles(request, callback) {
            return this.rpcCall(addSubtitles, $root.proto.AddSubtitlesRequest, $root.proto.SubtitlesResponse, request, callback);
        }, "name", { value: "AddSubtitles" });
         ...
         * @instance
         * @param {proto.IAddSubtitlesRequest} request AddSubtitlesRequest message or plain object
         * @returns {Promise<proto.SubtitlesResponse>} Promise
         * @variation 2
         */
