...
proto.proto.NotificationMsgEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    notification: (f = msg.getNotification()) && user_pb.Notification.toObject(includeInstance, f)
  };
...
proto.proto.NotificationMsgEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new user_pb.Notification;
      reader.readMessage(value,user_pb.Notification.deserializeBinaryFromReader);
...
proto.proto.NotificationMsgEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      user_pb.Notification.serializeBinaryToWriter
    );
  }
};
...
proto.proto.NotificationMsgEvent.prototype.getNotification = function() {
  return /** @type{?proto.proto.Notification} */ (
    jspb.Message.getWrapperField(this, user_pb.Notification, 1));
};
