 ...
 *   !proto.proto.Response>}
 */
const methodDescriptor_TheaterService_AddSubtitle = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.proto.TheaterServiceClient.prototype.addSubtitle =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/proto.TheaterService/AddSubtitle',
      request,
      metadata || {},
      methodDescriptor_TheaterService_AddSubtitle,
      callback);
};
 ...
 *     A native promise that resolves to the response
 */
proto.proto.TheaterServicePromiseClient.prototype.addSubtitle =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/proto.TheaterService/AddSubtitle',
      request,
