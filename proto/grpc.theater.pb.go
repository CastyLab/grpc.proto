...
var file_grpc_theater_proto_rawDesc = []byte{
	...
	0x53, 0x53, 0x5f, 0x42, 0x59, 0x5f, 0x52, 0x4f, 0x4c, 0x45, 0x53, 0x10, 0x03, 0x32, 0xc0, 0x04,
...
var file_grpc_theater_proto_depIdxs = []int32{
	...
	14, // 29: proto.TheaterService.RemoveMediaSource:input_type -> proto.MediaSourceRemoveRequest
	13, // 30: proto.TheaterService.AddMediaSource:input_type -> proto.MediaSourceAuthRequest
	9,  // 31: proto.TheaterService.RemoveSubtitle:input_type -> proto.RemoveSubtitleRequest
	21, // 32: proto.TheaterService.Invite:output_type -> proto.Response
	11, // 33: proto.TheaterService.GetTheater:output_type -> proto.UserTheaterResponse
	21, // 34: proto.TheaterService.UpdateTheater:output_type -> proto.Response
	10, // 35: proto.TheaterService.GetSubtitles:output_type -> proto.TheaterSubtitlesResponse
	15, // 36: proto.TheaterService.GetMediaSources:output_type -> proto.TheaterMediaSourcesResponse
	21, // 37: proto.TheaterService.RemoveMediaSource:output_type -> proto.Response
	21, // 38: proto.TheaterService.AddMediaSource:output_type -> proto.Response
	21, // 39: proto.TheaterService.RemoveSubtitle:output_type -> proto.Response
